...
class PeriodFilter {
    ...
    performSearch(searchData) {
        ...
        // });
        let selectElement = document.getElementById("organization-select");
        let data1 = {
            periodFrom: this.periodFrom.value,
            periodTo: this.periodTo.value,
        ...
        .then(blob => {
           // Из blob создаем URL
            ...
            imgElement.src = "static/plot3.png?" + new Date().getTime(); // Кладем src
            imgElement.alt = "static/plot3.png";
        ...
        var result = document.querySelector('.stat-salary');
        let data3 = {
            periodFrom: this.periodFrom.value,
            periodTo: this.periodTo.value,
            specialization: 'организация',
 ...
 */
function initOrganizationSelect(selectId = 'organization-select', apiUrl = '/all-orgs') {
    ...
    method: 'POST',})
        ...
        .then(org => {
            updateSelectOptions(selectElement, org);
        })
        .catch(error => {
 ...
 */
function updateSelectOptions(selectElement, org) {
